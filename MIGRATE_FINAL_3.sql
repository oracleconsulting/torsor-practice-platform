-- ==============================================================
-- MIGRATE THE 3 MISSING MEMBERS (Jaanu, James, Luke)
-- ==============================================================
...
BEGIN
  ...
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Migrating 3 missing members';
  RAISE NOTICE '========================================';

  -- Loop through the 3 specific invitations
  ...
  LOOP
    ...
    -- Find practice member by email (exact match)
    ...
    IF member_id IS NULL THEN
      ...
      RAISE NOTICE '   Checking for case-insensitive match...';
      ...
      IF member_id IS NULL THEN
        RAISE NOTICE '❌ Still no match found!';
        CONTINUE;
      ELSE
        RAISE NOTICE '✅ Found via case-insensitive match: %', member_id;
      END IF;
    ELSE
  ...
  RAISE NOTICE 'Assessments inserted: %', migrated_count;
