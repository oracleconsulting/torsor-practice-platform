// ============================================================================
// CANONICAL SERVICE REGISTRY — Frontend mirror
// ============================================================================
...
// === THE REGISTRY (same as _shared/service-registry.ts) ===
...
export const SERVICE_REGISTRY: Record<string, ServiceDefinition> = {
  ...
  'benchmarking': {
    ...
    tiers: [
      { name: 'Tier 1', tagline: 'Industry comparison and baseline', pricingModel: 'fixed', price: 2000, priceFormatted: '£2,000', period: 'one-off', periodLabel: '', examplePdfUrl: '/storage/service-examples/benchmarking-tier1.pdf', showInPopup: true, popupCtaLabel: 'View Example' },
      { name: 'Tier 2', tagline: 'Deep-dive with action plan', pricingModel: 'fixed', price: 4500, priceFormatted: '£4,500', period: 'one-off', periodLabel: '', examplePdfUrl: '/storage/service-examples/benchmarking-tier2.pdf', showInPopup: true, popupCtaLabel: 'View Example' },
    ],
    defaultTierIndex: 0,
    isActive: true,
  },
  'systems_audit': {
    ...
    tiers: [
      { name: 'Tier 1', tagline: 'Systems map and priority list', pricingModel: 'fixed', price: 2000, priceFormatted: '£2,000', period: 'one-off', periodLabel: '', examplePdfUrl: '/storage/service-examples/systems-audit-tier1.pdf', showInPopup: true, popupCtaLabel: 'View Example' },
      { name: 'Tier 2', tagline: 'Full audit with implementation roadmap', pricingModel: 'fixed', price: 4500, priceFormatted: '£4,500', period: 'one-off', periodLabel: '', examplePdfUrl: '/storage/service-examples/systems-audit-tier2.pdf', showInPopup: true, popupCtaLabel: 'View Example' },
    ],
    defaultTierIndex: 0,
    isActive: true,
  },
  'goal_alignment': {
    ...
    tiers: [
      { name: 'Lite', tagline: 'Survey + plan + one review', pricingModel: 'fixed', price: 1500, priceFormatted: '£1,500', period: 'annual', periodLabel: '/year', examplePdfUrl: '/storage/service-examples/goal-alignment-lite.pdf', showInPopup: true, popupCtaLabel: 'View Example' },
      { name: 'Growth', tagline: 'Quarterly reviews for 12 months', pricingModel: 'fixed', price: 4500, priceFormatted: '£4,500', period: 'annual', periodLabel: '/year', examplePdfUrl: '/storage/service-examples/goal-alignment-growth.pdf', showInPopup: true, popupCtaLabel: 'View Example' },
      { name: 'Partner', tagline: 'Strategy day + BSG integration', pricingModel: 'fixed', price: 9000, priceFormatted: '£9,000', period: 'annual', periodLabel: '/year', showInPopup: true, popupCtaLabel: 'Talk to us' },
    ],
    defaultTierIndex: 1,
    isActive: true,
  },
  'business_advisory': {
    ...
    tiers: [
      { name: 'Tier 1', tagline: 'Valuation and readiness assessment', pricingModel: 'fixed', price: 2000, priceFormatted: '£2,000', period: 'one-off', periodLabel: '', examplePdfUrl: '/storage/service-examples/business-advisory-tier1.pdf', showInPopup: true, popupCtaLabel: 'View Example' },
      { name: 'Tier 2', tagline: 'Full exit strategy and preparation', pricingModel: 'fixed', price: 4000, priceFormatted: '£4,000', period: 'one-off', periodLabel: '', examplePdfUrl: '/storage/service-examples/business-advisory-tier2.pdf', showInPopup: true, popupCtaLabel: 'View Example' },
    ],
    defaultTierIndex: 0,
    isActive: false,
  },
  'automation': {
    ...
    tiers: [
      { name: 'Project', tagline: 'Scoped automation implementation', pricingModel: 'fixed', price: 5000, priceFormatted: '£5,000', period: 'one-off', periodLabel: '', examplePdfUrl: '/storage/service-examples/automation-project.pdf', showInPopup: true, popupCtaLabel: 'View Example' },
      { name: 'Retainer', tagline: 'Ongoing automation support', pricingModel: 'fixed', price: 1500, priceFormatted: '£1,500', period: 'monthly', periodLabel: '/month', examplePdfUrl: '/storage/service-examples/automation-retainer.pdf', showInPopup: true, popupCtaLabel: 'View Example' },
    ],
    defaultTierIndex: 0,
    isActive: false,
  },
  'fractional_cfo': {
    ...
    tiers: [{ name: '2 days/month', tagline: 'Strategic finance leadership', pricingModel: 'fixed', price: 4000, priceFormatted: '£4,000', period: 'monthly', periodLabel: '/month', showInPopup: true, popupCtaLabel: 'Talk to us' }],
    defaultTierIndex: 0,
    isActive: false,
  },
  'fractional_coo': {
    ...
    tiers: [{ name: '2 days/month', tagline: 'Operational leadership', pricingModel: 'fixed', price: 3750, priceFormatted: '£3,750', period: 'monthly', periodLabel: '/month', showInPopup: true, popupCtaLabel: 'Talk to us' }],
    defaultTierIndex: 0,
    isActive: false,
  },
  'combined_advisory': {
    ...
    tiers: [{ name: 'Standard', tagline: 'Full executive partnership', pricingModel: 'fixed', price: 6000, priceFormatted: '£6,000', period: 'monthly', periodLabel: '/month', showInPopup: true, popupCtaLabel: 'Talk to us' }],
    defaultTierIndex: 0,
    isActive: false,
  },
};
...
export function getPriceForTurnover(tier: ServiceTier, turnover: number): { price: number; priceFormatted: string } {
  ...
  for (const band of tier.priceRanges) {
    if (band.maxTurnover === null || turnover <= band.maxTurnover) return { price: band.price, priceFormatted: band.priceFormatted };
  }
...
export function getEnabledByString(code: string, options?: { tierName?: string; turnover?: number; deferred?: boolean }): string {
  const def = SERVICE_REGISTRY[code];
  if (!def) return code;
...
export function getActiveServiceCodes(): string[] {
  return Object.entries(SERVICE_REGISTRY).filter(([, def]) => def.isActive).map(([code]) => code);
}
