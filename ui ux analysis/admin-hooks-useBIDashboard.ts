...
import type { MAFinancialData, MAKPIValue } from '../types/business-intelligence';
...
export function useBIDashboard(engagementId: string, periodId: string): MADashboardData {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      console.error('[useBIDashboard] Error:', err);
