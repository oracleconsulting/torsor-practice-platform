      ...
      <div className="p-6">
        <div className="flex items-center space-x-4">
          ...
          <div className="text-center border-l border-white/30 pl-6">
            ...
            <div className="text-sm text-white/80">Client Limit</div>
            <div className="text-xs text-white/70 mt-1">Quality Guaranteed</div>
          </div>
        </div>
        ...
        <div className="mt-4 pt-4 border-t border-white/30">
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              ...
              <div className="text-sm text-white/80">PE Focus</div>
            </div>
            <div>
