...
Action: Increase life tasks in low-scoring categories. Maintain high-scoring ones with lighter touch.`;
    ...
    try {
      ...
      if (bmRpt?.report_data) { bmSummaryBlock = buildBmSummaryBlock(bmRpt.report_data, bmRpt.value_analysis); console.log(`[Sprint2] BM summary block: ${bmSummaryBlock.length} chars`); }
