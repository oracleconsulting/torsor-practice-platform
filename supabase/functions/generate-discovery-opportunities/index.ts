...
const SERVICE_REGISTRY: Record<string, ServiceDefinition> = {
  business_intelligence: { code: 'business_intelligence', name: 'Business Intelligence', displayName: 'Business Intelligence', category: 'operational', outcome: "You'll Know Your Numbers", description: 'Monthly financial visibility.', keywords: ['business intelligence', 'management account', 'monthly reporting', 'financial', 'numbers', 'cash flow', 'P&L'], tiers: [{ name: 'Clarity', tagline: 'See where you are', pricingModel: 'turnover-scaled', priceRanges: [{ maxTurnover: 750000, price: 2000, priceFormatted: '£2,000' }, { maxTurnover: 2000000, price: 2500, priceFormatted: '£2,500' }, { maxTurnover: 5000000, price: 3000, priceFormatted: '£3,000' }, { maxTurnover: null, price: 3500, priceFormatted: '£3,500' }], priceFromFormatted: 'from £2,000', period: 'monthly', periodLabel: '/month', showInPopup: true, popupCtaLabel: 'View Example' }, { name: 'Foresight', tagline: 'See where you could be', pricingModel: 'turnover-scaled', priceRanges: [{ maxTurnover: 750000, price: 3000, priceFormatted: '£3,000' }, { maxTurnover: 2000000, price: 3500, priceFormatted: '£3,500' }, { maxTurnover: 5000000, price: 4500, priceFormatted: '£4,500' }, { maxTurnover: null, price: 5000, priceFormatted: '£5,000' }], priceFromFormatted: 'from £3,000', period: 'monthly', periodLabel: '/month', showInPopup: true, popupCtaLabel: 'View Example' }, { name: 'Strategic', tagline: 'Your financial partner', pricingModel: 'turnover-scaled', priceRanges: [{ maxTurnover: 2000000, price: 5000, priceFormatted: '£5,000' }, { maxTurnover: 5000000, price: 7000, priceFormatted: '£7,000' }, { maxTurnover: null, price: 10000, priceFormatted: '£10,000' }], priceFromFormatted: 'from £5,000', period: 'monthly', periodLabel: '/month', showInPopup: true, popupCtaLabel: 'Talk to us' }], defaultTierIndex: 0, isActive: true },
  benchmarking: { code: 'benchmarking', name: 'Industry Benchmarking', displayName: 'Industry Benchmarking (Full Package)', category: 'foundation', outcome: "You'll Know Where You Stand", description: 'Industry comparison.', keywords: ['benchmark', 'valuation', 'hidden value', 'baseline', 'industry'], tiers: [{ name: 'Tier 1', tagline: 'Industry comparison', pricingModel: 'fixed', price: 2000, priceFormatted: '£2,000', period: 'one-off', periodLabel: '', showInPopup: true, popupCtaLabel: 'View Example' }, { name: 'Tier 2', tagline: 'Deep-dive with action plan', pricingModel: 'fixed', price: 4500, priceFormatted: '£4,500', period: 'one-off', periodLabel: '', showInPopup: true, popupCtaLabel: 'View Example' }], defaultTierIndex: 0, isActive: true },
  systems_audit: { code: 'systems_audit', name: 'Systems & Process Audit', displayName: 'Systems & Process Audit', category: 'foundation', outcome: "You'll See What's Actually Running Your Business", description: 'A comprehensive review of your operational systems, processes, and dependencies. We map what\'s documented, what\'s assumed, what only lives in one person\'s head, and where the single points of failure are. Most founders discover they\'re the bottleneck in places they didn\'t expect.', keywords: ['systems', 'process', 'efficiency', 'automation', 'audit', 'delegation', 'bottleneck', 'dependency'], tiers: [{ name: 'The Map', tagline: "See What's Actually Running Your Business", pricingModel: 'fixed', price: 2000, priceFormatted: '£2,000', period: 'one-off', periodLabel: '', showInPopup: true, popupCtaLabel: 'View Example' }, { name: 'The Blueprint', tagline: 'See It, Fix It, Hand It Over', pricingModel: 'fixed', price: 4500, priceFormatted: '£4,500', period: 'one-off', periodLabel: '', showInPopup: true, popupCtaLabel: 'View Example' }], defaultTierIndex: 0, isActive: true },
  goal_alignment: { code: 'goal_alignment', name: 'Goal Alignment Programme', displayName: 'Goal Alignment Programme', category: 'growth', outcome: "You'll Have Someone In Your Corner", description: 'Quarterly accountability.', keywords: ['goal alignment', 'accountability', 'co-pilot', 'support', '365', 'alignment'], tiers: [{ name: 'Lite', tagline: 'Survey + plan', pricingModel: 'fixed', price: 1500, priceFormatted: '£1,500', period: 'annual', periodLabel: '/year', showInPopup: true, popupCtaLabel: 'View Example' }, { name: 'Growth', tagline: 'Quarterly reviews', pricingModel: 'fixed', price: 4500, priceFormatted: '£4,500', period: 'annual', periodLabel: '/year', showInPopup: true, popupCtaLabel: 'View Example' }, { name: 'Partner', tagline: 'Strategy day', pricingModel: 'fixed', price: 9000, priceFormatted: '£9,000', period: 'annual', periodLabel: '/year', showInPopup: true, popupCtaLabel: 'Talk to us' }], defaultTierIndex: 1, isActive: true },
  business_advisory: { code: 'business_advisory', name: 'Business Advisory & Exit Planning', displayName: 'Business Advisory & Exit Planning', category: 'strategic', outcome: "You'll Know What It's Worth", description: 'Protect and maximise value.', keywords: ['exit', 'sale', 'succession', 'planning', 'advisory'], tiers: [{ name: 'Tier 1', tagline: 'Valuation', pricingModel: 'fixed', price: 2000, priceFormatted: '£2,000', period: 'one-off', periodLabel: '', showInPopup: true, popupCtaLabel: 'View Example' }, { name: 'Tier 2', tagline: 'Full exit strategy', pricingModel: 'fixed', price: 4000, priceFormatted: '£4,000', period: 'one-off', periodLabel: '', showInPopup: true, popupCtaLabel: 'View Example' }], defaultTierIndex: 0, isActive: false },
  automation: { code: 'automation', name: 'Automation Services', displayName: 'Automation Services', category: 'operational', outcome: "The Manual Work Disappears", description: 'Eliminate manual work.', keywords: ['automation', 'automate', 'manual', 'integrate', 'workflow'], tiers: [{ name: 'Project', tagline: 'Scoped automation', pricingModel: 'fixed', price: 5000, priceFormatted: '£5,000', period: 'one-off', periodLabel: '', showInPopup: true, popupCtaLabel: 'View Example' }, { name: 'Retainer', tagline: 'Ongoing support', pricingModel: 'fixed', price: 1500, priceFormatted: '£1,500', period: 'monthly', periodLabel: '/month', showInPopup: true, popupCtaLabel: 'View Example' }], defaultTierIndex: 0, isActive: false },
...
function getActiveServiceCodes(): string[] { return Object.entries(SERVICE_REGISTRY).filter(([, def]) => def.isActive).map(([code]) => code); }
