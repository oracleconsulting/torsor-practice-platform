...
-- FIXED VERSION: Handles existing indexes/tables gracefully
-- ================================================================
...
-- Indexes for performance (use DROP IF EXISTS to avoid conflicts)
DROP INDEX IF EXISTS idx_personality_assessments_member;
CREATE INDEX idx_personality_assessments_member ON personality_assessments(team_member_id);

DROP INDEX IF EXISTS idx_personality_assessments_completed;
CREATE INDEX idx_personality_assessments_completed ON personality_assessments(completed_at);

DROP INDEX IF EXISTS idx_personality_assessments_work_style;
...
-- ================================================================
-- 5. RLS Policies for personality_assessments (drop existing first)
-- ================================================================

DROP POLICY IF EXISTS "Team members can manage their own personality assessment" ON personality_assessments;
DROP POLICY IF EXISTS "Managers and admins can view all personality assessments" ON personality_assessments;
...
-- ================================================================
-- 6. RLS Policies for team_member_profiles (drop existing first)
-- ================================================================

DROP POLICY IF EXISTS "Team members can view their own profile" ON team_member_profiles;
DROP POLICY IF EXISTS "System can manage profiles" ON team_member_profiles;
DROP POLICY IF EXISTS "Managers and admins can view all profiles" ON team_member_profiles;
...
-- ================================================================
-- 7. RLS Policies for team_compositions (drop existing first)
-- ================================================================

DROP POLICY IF EXISTS "Practice members can view team composition" ON team_compositions;
DROP POLICY IF EXISTS "Managers can update team composition" ON team_compositions;
...
-- ================================================================
-- 8. Triggers for updated_at (drop existing first)
-- ================================================================

DROP TRIGGER IF EXISTS personality_assessments_updated_at ON personality_assessments;
DROP FUNCTION IF EXISTS update_personality_assessment_updated_at();
...
DROP TRIGGER IF EXISTS team_member_profiles_updated_at ON team_member_profiles;
DROP FUNCTION IF EXISTS update_team_member_profiles_updated_at();
...
DROP TRIGGER IF EXISTS team_compositions_updated_at ON team_compositions;
DROP FUNCTION IF EXISTS update_team_compositions_updated_at();
...
-- ================================================================
-- 9. Views for Admin Dashboard (drop existing first)
-- ================================================================

DROP VIEW IF EXISTS team_assessment_overview;
...
DROP VIEW IF EXISTS practice_team_composition_summary;
...
-- ================================================================
-- 10. Helper Functions (drop existing first)
-- ================================================================

DROP FUNCTION IF EXISTS calculate_team_diversity(UUID);
...
DO $$
BEGIN
  RAISE NOTICE '✅ OCEAN Personality Assessment System installed successfully!';
  RAISE NOTICE '📊 Created 3 tables: personality_assessments, team_member_profiles, team_compositions';
  RAISE NOTICE '👁️ Created 2 views: team_assessment_overview, practice_team_composition_summary';
