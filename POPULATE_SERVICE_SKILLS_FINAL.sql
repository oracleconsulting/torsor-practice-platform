-- ==============================================================
-- COMPLETE SERVICE SKILLS POPULATION - CORRECT DATABASE NAMES
-- ==============================================================
...
BEGIN
  ...
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'automation', id, 3, 4, false FROM skills WHERE name = 'Data Import/Export';
  ...
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 3, 5, true FROM skills WHERE name = 'Budget Preparation';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 4, 5, true FROM skills WHERE name = 'Three-way Forecasting';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 4, 5, false FROM skills WHERE name = 'Scenario Planning';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 4, 5, false FROM skills WHERE name = 'Business Valuations';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 4, 5, true FROM skills WHERE name = 'Strategic Options Appraisal';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 4, 5, true FROM skills WHERE name = 'Commercial Thinking';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 3, 4, false FROM skills WHERE name = 'Working Capital Optimisation';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 3, 4, false FROM skills WHERE name = 'Advisory Selling';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 3, 4, false FROM skills WHERE name = 'Investment Appraisal';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 3, 4, false FROM skills WHERE name = 'Debt Management Advisory';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 3, 4, false FROM skills WHERE name = 'Investor Relations Support';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 3, 4, false FROM skills WHERE name = 'Business Model Analysis';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 4, 5, true FROM skills WHERE name = 'Board Presentation Skills';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 3, 4, false FROM skills WHERE name = 'Influencing & Persuasion';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 3, 4, false FROM skills WHERE name = 'Client Education';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'advisory-accelerator', id, 3, 4, false FROM skills WHERE name = 'Cost Reduction Analysis';
  ...
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, '365-alignment', id, 3, 4, false FROM skills WHERE name = '365 Alignment Facilitation';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, '365-alignment', id, 3, 4, false FROM skills WHERE name = 'Conflict Resolution';
  ...
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'systems-audit', id, 3, 4, false FROM skills WHERE name = 'Technical Research';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'systems-audit', id, 3, 4, false FROM skills WHERE name = 'Professional Scepticism';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'systems-audit', id, 3, 4, false FROM skills WHERE name = 'Cybersecurity Best Practices';
  
  -- ============================================================
  -- 7. PROFIT EXTRACTION / FRACTIONAL CFO/COO (service_id: 'profit-extraction')
  -- ============================================================
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'profit-extraction', id, 5, 5, true FROM skills WHERE name = 'Strategic Options Appraisal';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'profit-extraction', id, 5, 5, true FROM skills WHERE name = 'Commercial Thinking';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'profit-extraction', id, 4, 5, false FROM skills WHERE name = 'Debt Management Advisory';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'profit-extraction', id, 4, 5, false FROM skills WHERE name = 'Business Valuations';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'profit-extraction', id, 4, 5, false FROM skills WHERE name = 'Training Design & Delivery';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'profit-extraction', id, 4, 5, false FROM skills WHERE name = 'Investor Relations Support';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'profit-extraction', id, 5, 5, true FROM skills WHERE name = 'Board Presentation Skills';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'profit-extraction', id, 3, 4, false FROM skills WHERE name = 'Capital Gains Tax Planning';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'profit-extraction', id, 3, 4, false FROM skills WHERE name = 'Succession Planning';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'profit-extraction', id, 4, 5, false FROM skills WHERE name = 'Three-way Forecasting';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'profit-extraction', id, 4, 5, false FROM skills WHERE name = 'Working Capital Optimisation';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'profit-extraction', id, 4, 5, false FROM skills WHERE name = 'Innovation Leadership';
  
  INSERT INTO service_skill_assignments (practice_id, service_id, skill_id, minimum_level, ideal_level, is_critical)
  SELECT v_practice_id, 'profit-extraction', id, 4, 5, false FROM skills WHERE name = 'Performance Management';
...
SELECT 
  CASE ssa.service_id
    ...
    WHEN 'advisory-accelerator' THEN '3. Advisory / Future Financial Information'
