...
const SERVICE_REGISTRY: Record<string, ServiceDefinition> = {
  ...
  systems_audit: { code: 'systems_audit', name: 'Systems & Process Audit', displayName: 'Systems & Process Audit', category: 'foundation', outcome: "You'll See Where The Time Goes", description: 'Map systems and processes.', keywords: ['systems', 'process', 'efficiency', 'automation', 'audit'], tiers: [{ name: 'Tier 1', tagline: 'Systems map', pricingModel: 'fixed', price: 2000, priceFormatted: '£2,000', period: 'one-off', periodLabel: '', showInPopup: true, popupCtaLabel: 'View Example' }, { name: 'Tier 2', tagline: 'Full audit', pricingModel: 'fixed', price: 4500, priceFormatted: '£4,500', period: 'one-off', periodLabel: '', showInPopup: true, popupCtaLabel: 'View Example' }], defaultTierIndex: 0, isActive: true },
