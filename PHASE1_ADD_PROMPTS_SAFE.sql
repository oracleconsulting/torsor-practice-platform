-- =====================================================
-- PHASE 1: ADD ALL MISSING LLM PROMPTS TO AI SETTINGS (SAFE VERSION)
-- Checks for existing prompts and only inserts new ones
-- =====================================================
...
RAISE NOTICE 'Starting AI prompts migration...';
RAISE NOTICE '';

-- =====================================================
-- 1. SKILLS COACH - SKILLS CONTEXT
-- =====================================================
SELECT COUNT(*) INTO v_count FROM ai_prompts WHERE prompt_key = 'coach_skills' AND practice_id = v_practice_id;
IF v_count = 0 THEN
...
- Top Skills: {{top_skills}}',
    'openrouter', 'openai/gpt-4-turbo', 0.7, 500, true, 1
  );
  RAISE NOTICE '✅ Created: coach_skills';
ELSE
  RAISE NOTICE '⏭️  Skipped: coach_skills (already exists)';
END IF;

-- =====================================================
-- 2. SKILLS COACH - CPD CONTEXT
-- =====================================================
SELECT COUNT(*) INTO v_count FROM ai_prompts WHERE prompt_key = 'coach_cpd' AND practice_id = v_practice_id;
IF v_count = 0 THEN
  INSERT INTO ai_prompts (
    practice_id, name, description, category, prompt_key,
    system_prompt, user_prompt_template, model_provider, model_name,
...
- Learning Style: {{learning_style}}',
  ...
  RAISE NOTICE '✅ Created: coach_cpd';
ELSE
  RAISE NOTICE '⏭️  Skipped: coach_cpd (already exists)';
END IF;

-- =====================================================
-- 3. SKILLS COACH - MENTORING CONTEXT
-- =====================================================
SELECT COUNT(*) INTO v_count FROM ai_prompts WHERE prompt_key = 'coach_mentoring' AND practice_id = v_practice_id;
IF v_count = 0 THEN
  INSERT INTO ai_prompts (
    practice_id, name, description, category, prompt_key,
    system_prompt, user_prompt_template, model_provider, model_name,
...
- Role: {{role}}',
  ...
  RAISE NOTICE '✅ Created: coach_mentoring';
ELSE
  RAISE NOTICE '⏭️  Skipped: coach_mentoring (already exists)';
END IF;

-- =====================================================
-- 4. SKILLS COACH - CAREER CONTEXT
-- =====================================================
SELECT COUNT(*) INTO v_count FROM ai_prompts WHERE prompt_key = 'coach_career' AND practice_id = v_practice_id;
IF v_count = 0 THEN
  INSERT INTO ai_prompts (
    practice_id, name, description, category, prompt_key,
    system_prompt, user_prompt_template, model_provider, model_name,
...
- Top Skills: {{top_skills}}',
  ...
  RAISE NOTICE '✅ Created: coach_career';
ELSE
  RAISE NOTICE '⏭️  Skipped: coach_career (already exists)';
END IF;

-- =====================================================
-- 5. SKILLS COACH - GENERAL CONTEXT
-- =====================================================
SELECT COUNT(*) INTO v_count FROM ai_prompts WHERE prompt_key = 'coach_general' AND practice_id = v_practice_id;
IF v_count = 0 THEN
  INSERT INTO ai_prompts (
    practice_id, name, description, category, prompt_key,
    system_prompt, user_prompt_template, model_provider, model_name,
...
- Name: {{member_name}}',
  ...
  RAISE NOTICE '✅ Created: coach_general';
ELSE
  RAISE NOTICE '⏭️  Skipped: coach_general (already exists)';
END IF;

-- =====================================================
-- 6. CPD RECOMMENDATIONS
-- =====================================================
SELECT COUNT(*) INTO v_count FROM ai_prompts WHERE prompt_key = 'cpd_recommendations' AND practice_id = v_practice_id;
IF v_count = 0 THEN
  INSERT INTO ai_prompts (
    practice_id, name, description, category, prompt_key,
    system_prompt, user_prompt_template, model_provider, model_name,
...
Format as a numbered list with activity name, type, estimated hours, and brief description.',
    'openrouter', 'openai/gpt-4-turbo', 0.7, 600, true, 1
  );
  RAISE NOTICE '✅ Created: cpd_recommendations';
ELSE
  RAISE NOTICE '⏭️  Skipped: cpd_recommendations (already exists)';
END IF;

-- =====================================================
-- 7. SKILL IMPROVEMENT PLAN
-- =====================================================
SELECT COUNT(*) INTO v_count FROM ai_prompts WHERE prompt_key = 'skill_improvement_plan' AND practice_id = v_practice_id;
IF v_count = 0 THEN
  INSERT INTO ai_prompts (
    practice_id, name, description, category, prompt_key,
    system_prompt, user_prompt_template, model_provider, model_name,
...
Be specific and actionable.',
    'openrouter', 'openai/gpt-4-turbo', 0.7, 800, true, 1
  );
  RAISE NOTICE '✅ Created: skill_improvement_plan';
ELSE
  RAISE NOTICE '⏭️  Skipped: skill_improvement_plan (already exists)';
END IF;

-- =====================================================
-- 8. INTERVIEW PREPARATION
-- =====================================================
SELECT COUNT(*) INTO v_count FROM ai_prompts WHERE prompt_key = 'interview_prep' AND practice_id = v_practice_id;
IF v_count = 0 THEN
  INSERT INTO ai_prompts (
    practice_id, name, description, category, prompt_key,
    system_prompt, user_prompt_template, model_provider, model_name,
...
Be practical and boost their confidence.',
    'openrouter', 'openai/gpt-4-turbo', 0.7, 1000, true, 1
  );
  RAISE NOTICE '✅ Created: interview_prep';
ELSE
  RAISE NOTICE '⏭️  Skipped: interview_prep (already exists)';
END IF;

-- =====================================================
-- 9. CAREER PATHWAY
-- =====================================================
SELECT COUNT(*) INTO v_count FROM ai_prompts WHERE prompt_key = 'career_pathway' AND practice_id = v_practice_id;
IF v_count = 0 THEN
  INSERT INTO ai_prompts (
    practice_id, name, description, category, prompt_key,
    system_prompt, user_prompt_template, model_provider, model_name,
...
Be realistic but encouraging.',
    'openrouter', 'openai/gpt-4-turbo', 0.8, 1000, true, 1
  );
  RAISE NOTICE '✅ Created: career_pathway';
ELSE
  RAISE NOTICE '⏭️  Skipped: career_pathway (already exists)';
END IF;
...
RAISE NOTICE '========================================';
RAISE NOTICE '';
RAISE NOTICE 'Check AI Settings page to see all prompts.';
RAISE NOTICE 'Prompts are now editable via admin portal!';
