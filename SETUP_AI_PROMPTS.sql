-- =====================================================
-- SETUP AI PROMPTS FOR TEAM ANALYSIS
-- This creates the missing AI prompt configurations
-- =====================================================

-- First, check if ai_prompts table exists and what's in it
DO $$
BEGIN
  RAISE NOTICE 'Checking existing AI prompts...';
END $$;
...
-- Insert team_composition_analysis prompt if it doesn't exist
...
-- Insert gap_analysis_insights prompt if it doesn't exist
INSERT INTO ai_prompts (
  practice_id,
  prompt_key,
  model_name,
...
DO $$
BEGIN
  RAISE NOTICE '✅ AI prompts created/updated successfully!';
END $$;
